                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <?php
                                        if (!empty($order->estimate_date)) {
                                            $estimate_date = date("Y/m/d", strtotime($order->estimate_date));
                                        } else {
                                            $estimate_date = date("Y/m/d");
                                        }

                                        if (!empty($order->valid_until)) {
                                            $valid_until = date("Y/m/d", strtotime($order->valid_until));
                                        } else {
                            ...
                            <input type="hidden" name="estimate_id" value="<?php if (!empty($order)) echo str_replace(array('+', '/', '='), array('-', '_', '~'), $this->encrypt->encode($order->id)) ?>">
