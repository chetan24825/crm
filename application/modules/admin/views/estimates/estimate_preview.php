            ...
            <div class="ibox-content p-xl">
                <section class="invoice">
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            <a onclick="return confirm('Are you sure want to delete this Invoice ?');" href="<?php echo base_url() ?>admin/estimates/deleteEstimate/<?php echo get_orderID($estimate->id) ?> " class="btn btn-danger pull-right" style="margin-right: 5px;">
                                <i class="fa fa-trash"></i> <?= lang('delete') ?>
                            </a>
                            <a href="<?php echo base_url() ?>admin/estimates/createPdfInvoice//<?php echo get_orderID($estimate->id) ?>" class="btn btn-info pull-right" style="margin-right: 5px;">
                                <i class="fa fa-download"></i> <?= lang('generate_pdf') ?>
                            </a>

                            <a href="<?php echo base_url() ?>admin/estimates/sendEstimate/<?php echo get_orderID($estimate->id) ?>" data-target="#modalSmall" data-toggle="modal" class="btn btn-primary pull-right" style="margin-right: 5px;">
                                <i class="fa fa-envelope"></i> <?= lang('email') ?>
                            </a>

                            <a href="<?php echo base_url() ?>admin/estimates/updateEstimate/<?php echo get_orderID($estimate->id) ?> " class="btn btn-success pull-right" style="margin-right: 5px;">
