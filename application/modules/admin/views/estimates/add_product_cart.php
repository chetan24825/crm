    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover" id="tireFields">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group form-group-bottom p_div">
                            <select class="form-control select2" style="width: 100%; z-index: 9999" onchange="get_estimate_product_id(this)" id="<?php echo $cart['rowid']?>">
                    ...
                    <td>
                        <div class="form-group form-group-bottom">
                            ...
                            <?php }else{ ?>
                                <input class="form-control" type="text" name="description" onblur ="estimate_updateItem(this);" id="<?php echo 'des'.$cart['rowid'] ?>" value="<?php echo $cart['description']?>">
                            <?php } ?>
                        </div>
                    </td>
                    <td>
                        <div class="form-group form-group-bottom">
                            <input class="form-control" type="text" name="price" value="<?php echo $cart['price'] ?>" onblur ="estimate_updateItem(this);" id="<?php echo 'prc'.$cart['rowid'] ?>">
                        </div>
                    </td>                    
                    <td>
                        <div class="form-group form-group-bottom">
                            <input class="form-control" type="text" name="qty" onblur ="estimate_updateItem(this);" value="<?php echo $cart['qty'] ?>" id="<?php echo 'qty'.$cart['rowid'] ?>">
                        </div>
                    </td>
                    <td>
                        <div class="form-group form-group-bottom">
                    ...
                    <td>
                        <a href="javascript:void(0)" id="<?php echo $cart['rowid'] ?>" onclick="estimate_removeItem(this);"  class="remTire" style="color: red"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group form-group-bottom p_div">
                        <select class="form-control select2" style="width: 100%; z-index: 9999" onchange="get_estimate_product_id(this)" id="">
                            <option value=""><?= lang('please_select') ?>..</option>
                            <?php if(!empty($products)){ foreach ($products as $key => $product){ ?>
                                <optgroup label="<?php echo $key?>">
                                    <?php foreach ($product as $item){ ?>
    ...
    <table class="table table-hover">
        ...
        <?php if ($this->session->userdata('type') != 'quotation') { ?>
            ...
            <tr>
                ...
                <td style="text-align: right; padding-right: 30px">
                    <select name="gst_tax" class="form-control select2" style="width: 100%;" onchange="get_estimate_gstTaxCalculate(this)" id="gst_tax">
                        <option value=""><?= lang('please_select') ?>..</option>
            ...
            <tr>
                ...
                <td style="text-align: right; padding-right: 30px">
                    <select name="igst_tax" class="form-control select2" style="width: 100%;" onchange="get_estimate_igstTaxCalculate(this)" id="igst_tax">
                        <option value=""><?= lang('please_select') ?>..</option>
            ...
            <tr>
                ...
                <td style="text-align: right; padding-right: 30px">
                    <select name="cgst_tax" class="form-control select2" style="width: 100%;" onchange="get_estimate_cgstTaxCalculate(this)" id="cgst_tax">
                        <option value=""><?= lang('please_select') ?>..</option>
            ...
            <tr>
                ...
                <td style="text-align: right; padding-right: 30px">
                    <select name="sgst_tax" class="form-control select2" style="width: 100%;" onchange="get_estimate_sgstTaxCalculate(this)" id="sgst_tax">
                        <option value=""><?= lang('please_select') ?>..</option>
            ...
            <tr>
                ...
                <td style="text-align: right; padding-right: 30px">
                    <input type="" class="form-control" style="text-align: right" onblur="estimate_order_discount(this)" value="<?php echo $this->session->userdata('discount');?>" name="discount">
                </td>
