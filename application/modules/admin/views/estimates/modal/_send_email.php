...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Send Estimate</h4>
</div>

<div class="modal-body">


    <form id="addPayment" action="<?php echo site_url('admin/estimates/sendEmail')?>" method="post" onsubmit="return get_Cookie('csrf_cookie_name')" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <textarea id="compose-textarea" name="msg" class="form-control" style="height: 300px">
                ...
                Please find out the Quotaion Details, attach with this email.</br>
        ...
        <div class="modal-footer" >
            ...
            <button type="submit" class="btn bg-olive btn-flat" id="btn" >Send Estimate</button>
