...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="addPayment" action="<?php echo site_url('admin/mail/sendHostingEmail') ?>" method="post" onsubmit="return get_Cookie('csrf_cookie_name')" enctype="multipart/form-data">
            ...
            <div class="box box-primary">
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="Subject:" name="subject" value="<?php echo $hosting->hosting_company; ?>">
                </div>
                <div class="form-group">
                    <textarea id="compose-textarea" name="msg" class="form-control" style="height: 300px">
                Dear <?php echo $customer->name ?>,</br>
                Your <?php echo $hosting->hosting_company; ?> domain is going to expire soon.</br>
            </br>
            </br>
            </br>
                Regards
