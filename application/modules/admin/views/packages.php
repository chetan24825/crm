            ...
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    <div class="input-group input-group-sm">
                        <a class="btn btn-primary btn-sm btn-flat" onclick="add()"><i class="fa fa-fw fa-plus"></i>Add New Package</a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var table;
    var list = 'admin/packages/package_list';
    var saveRow = 'admin/packages/add_package';
    ...
    function editPackage(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/packages/edit_package/') ?>/" + id,
            type: "GET",
            data: {
