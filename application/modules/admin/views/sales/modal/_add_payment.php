...
<div class="modal-body">
    ...
    <form id="addPayment" action="<?php echo site_url('admin/sales/received_payment')?>" method="post" onsubmit="return get_Cookie('csrf_cookie_name')" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group form-group-bottom">
                    ...
                    <input id="amount" name="amount" class="form-control" value="<?php if(!empty($payment)){ echo $payment->amount ;}else{ echo $order->due_payment; } ?>" type="text" onkeyup="receivedAmount(this);">
        ...
        <div class="modal-footer" >
            ...
            <button type="button" id="close" class="btn btn-white btn-sm" data-dismiss="modal"><?= lang('close') ?></button>
            <button type="submit" class="btn btn-primary btn-sm" id="btn" ><?= lang('save') ?></button>
