...
<script>
    ...
    var table;
    var list        = 'admin/tax/tax_list';
    var saveRow     = 'admin/tax/add_tax';
    var edit        = 'admin/tax/update_tax';
    var deleteRow   = 'admin/tax/delete_tax/';
    ...
    function edit_title(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/tax/edit_tax/')?>/" + id,
            type: "GET",
