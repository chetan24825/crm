...
$config['tables']['customer_users']  = 'customer_users';
 ...
 */
$config['site_title']                 = "Brutecorp";       // Site Title, example.com
$config['admin_email']                = "noreply@brutecorp.com"; // Admin Email, admin@example.com
$config['default_group']              = 'admin';             // Default group, use name
$config['customer_group']			  = 'customers';
...
$config['identity']                   = 'username';          // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
$config['identity_email']             = 'email'; 
$config['min_password_length']        = 8;                   // Minimum Required Length of Password
$config['max_password_length']        = 20;                  // Maximum Allowed Length of Password
$config['email_activation']           = TRUE;               // Email Activation for registration
$config['customer_email_activation']  = TRUE;               // Email Activation for registration
$config['manual_activation']          = FALSE;               // Manual Activation for registration
$config['customer_manual_activation']   = TRUE;				 // Manual Activation for customer registration
...
$config['identity_cookie_name'] = 'identity_email';
...
$config['use_customer_ci_email'] = TRUE; // Send Email using the builtin CI email class, if false it will return the code and the identity
