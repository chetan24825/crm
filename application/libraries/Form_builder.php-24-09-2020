...
class Form_builder {
	...
	public function create_form($url = NULL, $multipart = TRUE, $attributes = array())
	{
...
class Form {
	...
	public function bs2_text($label, $name, $value = NULL, $extra = array())
	{
	...
	public function bs4_submit($label =null, $class = 'btn btn-primary btn-sm ', $extra = array())
	{
		$extra['class'] = $class;
		return $this->btn_submit($label, $extra);
	}
